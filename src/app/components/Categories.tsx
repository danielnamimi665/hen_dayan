          ...
          <div className="hidden lg:flex space-x-8 space-x-reverse">
            {categories.map((category) => (
              <button
                ...
                className="py-4 px-2 text-sm font-medium border-b-4 border-transparent text-black hover:text-black hover:border-black transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-transparent"
              >
                {category}
              </button>
            ))}
          ...
          <div className="lg:hidden">
            <div className="grid grid-cols-2 gap-4 py-6 px-4">
              {categories.map((category) => (
                ...
                >
                  <div className="w-12 h-12 rounded-lg mb-3 flex items-center justify-center bg-gray-200 text-gray-700">
